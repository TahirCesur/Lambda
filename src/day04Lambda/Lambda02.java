...
public class Lambda02 {
    ...
    public static void main(String[] args) {
        ...
        EncapsuleUniversiteLambda02 iktisatBolum = new EncapsuleUniversiteLambda02("IIBF", "İktisat", 98, 134);
        EncapsuleUniversiteLambda02 matematikBolum = new EncapsuleUniversiteLambda02("FenEdebiyat", "Matematik", 95, 142);
        EncapsuleUniversiteLambda02 ingilizceBolum = new EncapsuleUniversiteLambda02("IngilizDili", "İngilizce", 93, 154);
        ...
        // 1- Tum ortalama puanlarin 91 den buyuk olup olmadigini kontrol etmek icin bir tontem olusturunuz...
